...
class GroupTransparency:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GroupTransparency_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Group Transparency')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GroupTransparency', message)
